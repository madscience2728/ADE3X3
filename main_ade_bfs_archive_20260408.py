#!/usr/bin/env python3
"""
ADE3×3 — Algebra Discovery Engine
Real-time axiom graph explorer with live TUI.

Usage:
  python main.py                          # default ranks, live TUI
  python main.py --ranks 19,22,23         # specific ranks
  python main.py --max-states 100000      # deeper search
  python main.py --no-tui                 # plain text output
"""

import sys, os, time, argparse, json, multiprocessing, pickle, math
